...
* Harden MessageHandler in crmMockServer.js to avoid issues where we cannot find a callback for an operation.
...
* Added socketTimeoutMS and connectTimeoutMS to socket options for repl_set.js and crmMockServer.js
...
* Correctly emit errors from crmMockServer.js only wrapping errors that are strings
